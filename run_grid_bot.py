...
def load_config():
    """Load configuration from configs/active/grid_config.json"""
    try:
        ...
        print(f"❌ Invalid JSON in {GRID_CONFIG_PATH}.")
        sys.exit(1)
...
def validate_config(config):
    ...
    if api_key == 'your-openalgo-apikey-here':
        print(f"❌ Please update your OpenAlgo API key in {GRID_CONFIG_PATH}")
        return False
